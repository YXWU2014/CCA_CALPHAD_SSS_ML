...
for i = 1: length(comb_D_E)
    ...
    %% copy the .m file
    % Source file path
    srcFilePath_1 = fullfile(current_path, 'v6_A_B_C_D_E_Gmin_FullEquil_SputterCompo_master.m');
     
    % New file name
    newFileName_1  = ['v6_', comb_A_B_C_D_E_temp, '_Gmin_FullEquil_SputterCompo.m'];
